...
function buildRelatedSection(currentId, allItems, type, count) {
  ...
  for (var i = 0; i < picked.length; i++) {
    ...
    cards +=
      '<a href="' + href(bp + item.id + '/') + '" class="related-card" data-related="' + escapeHtml(relData) + '">' +
...
function renderIndex(){
  ...
  for (var i = 0; i < games.length; i++) {
    ...
    gameList +=
      '<div class="game-card" data-game="' + escapeHtml(gameData) + '">' +
  ...
  for (var i = 0; i < webTools.length; i++) {
    ...
    webToolsList +=
      '<div class="game-card" data-tool="' + escapeHtml(toolData) + '">' +
  ...
  var body =
    ...
    // Games Section
    '<div id="games" style="margin:40px 0 20px">' +
    ...
    // Web Tools Section
    '<div id="web-tools" style="margin:60px 0 20px">' +
    ...
    '<div id="fun-tools" style="margin:60px 0 20px">' +
