...
function renderIndex(){
  ...
  var body =
    ...
    '<p style="text-align:center;font-size:20px;margin:16px 0;font-weight:500" data-i18n="mainDesc">?щ??덈뒗 寃뚯엫怨??좎슜???꾧뎄濡??쇱긽?????띿슂濡?쾶!</p>' +
    '<p id="total-count" style="text-align:center;font-size:16px;margin:8px 0;opacity:0.9" data-count="' + totalCount + '">珥?' + totalCount + '媛쒖쓽 寃뚯엫怨??꾧뎄媛 以鍮꾨릺???덉뒿?덈떎</p>' +
    '</div>' +
    '<section class="seo-content">' +
    ...
    '<h2 style="font-size:2rem;text-align:center;margin-bottom:10px" data-i18n="gamesSection">?렜 ?먮뇤 ?덈젴 寃뚯엫</h2>' +
    '<p style="text-align:center;color:#94a3b8;margin-bottom:30px" data-i18n="gamesSectionDesc">諛섏쓳?띾룄, 湲곗뼲?? 吏묒쨷?μ쓣 ?뚯뒪?명븯?몄슂!</p>' +
    '</div>' +
    '<div class="grid">' + gameList + '</div>' +

    // Web Tools Section
    '<div style="margin:60px 0 20px">' +
    '<h2 style="font-size:2rem;text-align:center;margin-bottom:10px" data-i18n="webToolsSection">?썱截?媛쒕컻???꾧뎄</h2>' +
    ...
    '<div style="margin:60px 0 20px">' +
    '<h2 style="font-size:2rem;text-align:center;margin-bottom:10px" data-i18n="funToolsSection">???щ? & ?좏떥由ы떚</h2>' +
    '<p style="text-align:center;color:#94a3b8;margin-bottom:30px" data-i18n="funToolsSectionDesc">?댁꽭, 怨꾩궛湲? ?뚯뒪?????ㅼ뼇???꾧뎄</p>' +
    '</div>' +
