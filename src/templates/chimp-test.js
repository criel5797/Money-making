  ...
  var gameHTML = `
    ...
    <div class="game-card" style="text-align:center">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-top:24px">
        ...
        <div class="stat-box"><div class="stat-label" data-i18n-game="chimp.bestLevel">최고 기록</div><div id="chimp-best" class="stat-value">0</div></div>
      </div>
    ...
    <script>
      ...
      var level=4,bestLevel=0,strikes=0,maxStrikes=3,currentNum=1,numbers=[],tiles=[],playing=false,numbersHidden=false;
